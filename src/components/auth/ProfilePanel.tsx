      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm h-full bg-background/95 backdrop-blur-xl border-l border-white/10 shadow-2xl flex flex-col scrollbar-hide overflow-y-auto touch-pan-y"
            style={{ WebkitOverflowScrolling: 'touch' }}
          >
            <div className="flex items-center justify-between sticky top-0 bg-background/95 p-6 z-20 border-b border-white/5 shrink-0">
            ...
            {user ? (
              <div className="flex flex-col px-6 pb-6 pt-2 min-h-max flex-1 shrink-0">
