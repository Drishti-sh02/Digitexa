                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="pt-6 mt-6 border-t border-white/10 flex flex-col items-center justify-center gap-2">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6">
                          ...
                          <a href="mailto:digitech@gmail.com" className="flex items-center gap-2 text-sm text-white/90 hover:text-primary transition-colors"><Mail className="w-4 h-4" /> digitech@gmail.com</a>
